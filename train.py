...
def main(config):
    ...
    root_path = os.path.join(datapath, f'{size_}train_dataset')
    ...
    # train_dataset = KistDataset(train_set, size=size)
    # valid_dataset = KistDataset(valid_set, size=size)
    ...
    for epoch in range(epochs):
        ...
        if val_loss < best_score:
            ...
            if epoch >= 5:
                ...
                test_dataset = KistDataset(test_set, size=size, is_test=True)
